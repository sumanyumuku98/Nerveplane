...
integrated system can still be broken, and only a real merge-and-test reveals it. The coordination win
is structural. It lives in work allocation, not model reasoning, so it survives stronger models rather
...
integrated. Deciding it needs an \emph{environment-grounded} verifier that reads ground-truth
